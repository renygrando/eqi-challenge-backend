...
Sistema de recebimento de leads via webhook. Integra com a plataforma
**LeadFlow** para captura e persistência de leads de campanhas de marketing.

## Stack

- [NestJS](https://nestjs.com/) — framework
- [TypeORM](https://typeorm.io/) — ORM - mikro-orm
